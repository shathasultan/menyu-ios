...
- [x] شعار قوقل: مُنفَّذ. الزر صار `GoogleSignInButton` من `GoogleSignInSwift`
      (منتج مربوط بالهدف أصلًا)، فالشعار والنص والقياسات من قوقل نفسها. لا
      أصل يدوي ولا شعار مقارب.
